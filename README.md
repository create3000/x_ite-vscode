...
[![Open VSX Registry](https://img.shields.io/static/v1?label=Open%20VSX%20Registry&message=x-ite-vscode&color=c160ef)](https://open-vsx.org/extension/create3000/x-ite-vscode)
...
Console messages are visible directly in the Preview tab. Additionally, console messages are redirected to the Output panel of VS Code when switching to the "X_ITE" channel.
